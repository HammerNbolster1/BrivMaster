...
;Modifed AHK JSON Library for working with the game setting file - as JSON lacks a boolean type 'x'=false or 'y'=true gets turned into numeric values as standard, this version preserves them
